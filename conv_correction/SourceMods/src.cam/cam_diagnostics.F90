...
!nedkleiner
   call addfld ('SDIFF   ','K       ',pver, 'I','S diff',phys_decomp)
   call addfld ('UDIFF   ','m/s     ',pver, 'I','U diff',phys_decomp)
   call addfld ('VDIFF   ','m/s     ',pver, 'I','V diff',phys_decomp)
   call addfld ('QDIFF   ','kg/kg   ',pver, 'I','Q diff',phys_decomp)
...
!if (abs(state%sforce(1,1))>0.00001) then
