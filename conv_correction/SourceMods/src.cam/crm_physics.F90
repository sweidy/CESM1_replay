...
! July, 2009, Minghuai Wang: m2005_effradius
   ! sweid - adding convective correction
!
!---------------------------------------------------------------------------
   ...
   public :: swap_to_crm_state, swap_from_crm_state
...
!
   ...
   ! swap state here 
   call swap_to_crm_state(ztodt, state,tend)
...
! state should be adjusted before here at least
...
! tendency from other parts of crmclouds_aerosol_wet_intr are still updated here.
      ...
      !if (masterproc) then
      !   print*, "after physics update in crm"
      !   print*, state%s(1,5)
      !   print*, state%t(1,5)
      !endif
...
!
   ...
   call swap_from_crm_state(ztodt, state,tend)
...
subroutine swap_to_crm_state (ztodt, state,tend)
   !----------------------------------------------------------------------- 
      ! Purpose: 
      !-----------------------------------------------------------------------
   ...
   !-----
      ...
      print*, "add convforce"
      !print*, ptend%s(1,5)
      !print*, state%sconvforce(1,5) ! lower number is higher level
      print*, state%s(1,5)
      !print*, state%t(1,5)
      endif
...
end subroutine swap_to_crm_state

subroutine swap_from_crm_state (ztodt, state,tend)
      !----------------------------------------------------------------------- 
      ! Purpose: 
      !-----------------------------------------------------------------------
      use physconst,    only: cpair
   ...
   !-----
      ...
      print*, "subtract convforce"
      !print*, ptend%s(1,5)
      !print*, state%sconvforce(1,5)
      print*, state%s(1,5)
      !print*, state%t(1,5)
      endif
...
end subroutine swap_from_crm_state
