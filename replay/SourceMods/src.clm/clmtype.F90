...
type, public :: pft_pstate_type
   ...
   integer , pointer :: old_frac_veg_nosno_alb(:)
   ...
   real(r8), pointer :: old_htop(:)
   real(r8), pointer :: hbot(:)                 !canopy bottom (m)
   real(r8), pointer :: old_hbot(:)
...
type, public :: pft_eflux_type
   ...
   real(r8), pointer :: old_eflx_lwrad_out(:)
...
type, public :: column_pstate_type
   ...
   real(r8), pointer :: old_snowdp(:)
   real(r8), pointer :: frac_sno(:)           !fraction of ground covered by snow (0 to 1)
   real(r8), pointer :: old_frac_sno(:)
   ...
   real(r8), pointer :: old_albgrd(:,:)
   real(r8), pointer :: albgri(:,:)           !ground albedo (diffuse) (numrad)
   real(r8), pointer :: old_albgri(:,:)
...
type, public :: column_wstate_type
   ...
   real(r8), pointer :: old_h2osoi_liq(:,:)       !liquid water (kg/m2) (new) (-nlevsno+1:nlevgrnd)    
   real(r8), pointer :: h2osoi_ice(:,:)       !ice lens (kg/m2) (new) (-nlevsno+1:nlevgrnd)    
   real(r8), pointer :: old_h2osoi_ice(:,:)
...
type, public :: column_eflux_type
   ...
   real(r8), pointer :: old_eflx_urban_ac(:)
   real(r8), pointer :: eflx_urban_ac(:)      ! urban air conditioning flux (W/m**2)
   real(r8), pointer :: old_eflx_urban_heat(:)
...
type, public :: column_wflux_type
   ...
   real(r8), pointer :: old_qflx_snofrz_lyr(:,:)
...
type, public :: landunit_pstate_type
   ...
   real(r8), pointer :: old_sabs_roof_dir(:,:)      
   real(r8), pointer :: old_sabs_roof_dif(:,:)      
   real(r8), pointer :: old_sabs_sunwall_dir(:,:)   
   real(r8), pointer :: old_sabs_sunwall_dif(:,:)   
   real(r8), pointer :: old_sabs_shadewall_dir(:,:) 
   real(r8), pointer :: old_sabs_shadewall_dif(:,:) 
   real(r8), pointer :: old_sabs_improad_dir(:,:)   
   real(r8), pointer :: old_sabs_improad_dif(:,:)   
   real(r8), pointer :: old_sabs_perroad_dir(:,:)   
   real(r8), pointer :: old_sabs_perroad_dif(:,:)   
