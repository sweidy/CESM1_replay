...
!------------------------------------------------------------------------
    ...
    allocate(p%gridcell(beg:end),p%old_wtgcell(beg:end))
    allocate(p%landunit(beg:end),p%old_wtlunit(beg:end))
    allocate(p%column  (beg:end),p%old_wtcol  (beg:end))
...
!------------------------------------------------------------------------
    ...
    allocate(pps%old_frac_veg_nosno_alb(beg:end))
    ...
    allocate(pps%old_tlai(beg:end))
    allocate(pps%old_tsai(beg:end))
    allocate(pps%old_elai(beg:end))
    allocate(pps%old_esai(beg:end))
    allocate(pps%old_fwet(beg:end))
    allocate(pps%fdry(beg:end))
    allocate(pps%dt_veg(beg:end))
    allocate(pps%htop(beg:end))
    allocate(pps%hbot(beg:end))
    allocate(pps%old_htop(beg:end))
    allocate(pps%old_hbot(beg:end))
    ...
    allocate(pps%old_albd(beg:end,1:numrad))
    allocate(pps%old_albi(beg:end,1:numrad))
    allocate(pps%old_fabd(beg:end,1:numrad))
    allocate(pps%old_fabi(beg:end,1:numrad))
    allocate(pps%old_ftdd(beg:end,1:numrad))
    allocate(pps%old_ftid(beg:end,1:numrad))
    allocate(pps%old_ftii(beg:end,1:numrad))
    ...
    allocate(pps%old_gdir(beg:end))
    allocate(pps%omega(beg:end,1:numrad))
    allocate(pps%old_omega(beg:end,1:numrad))
...
!-----------------------------------------------------------------------
    ...
    allocate(pes%old_t_ref2m(beg:end))
    ...
    allocate(pes%old_t_ref2m_u(beg:end))
    allocate(pes%old_t_ref2m_r(beg:end))
    ...
    allocate(pes%old_t_veg(beg:end))
...
!------------------------------------------------------------------------
    ...
    allocate(pws%old_h2ocan(beg:end))
...
!------------------------------------------------------------------------
    ...
    allocate(pef%old_eflx_lwrad_out(beg:end))
...
!------------------------------------------------------------------------
    ...
    allocate(cps%old_snl(beg:end))      !* cannot be averaged up
    ...
    allocate(cps%old_snowdp(beg:end))
    allocate(cps%frac_sno (beg:end))
    allocate(cps%old_frac_sno (beg:end))
    ...
    allocate(cps%old_zi(beg:end,-nlevsno+0:nlevgrnd))
    allocate(cps%old_dz(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cps%old_z (beg:end,-nlevsno+1:nlevgrnd))
    ...
    allocate(cps%old_albgrd(beg:end,numrad))
    allocate(cps%old_albgri(beg:end,numrad))
...
!   allocate(cps%xirrig(beg:end))
    ...
    allocate(cps%old_coszen(beg:end))
    ...
    allocate(cps%old_albsnd_hst(beg:end,numrad))
    allocate(cps%old_albsni_hst(beg:end,numrad))
    ...
    allocate(cps%old_flx_absdv(beg:end,-nlevsno+1:1))
    allocate(cps%old_flx_absdn(beg:end,-nlevsno+1:1))
    allocate(cps%old_flx_absiv(beg:end,-nlevsno+1:1))
    allocate(cps%old_flx_absin(beg:end,-nlevsno+1:1))
    allocate(cps%snw_rds(beg:end,-nlevsno+1:0))
    allocate(cps%old_snw_rds(beg:end,-nlevsno+1:0))
    ...
    allocate(cps%old_mss_bcpho(beg:end,-nlevsno+1:0))
    allocate(cps%old_mss_bcphi(beg:end,-nlevsno+1:0))
    ...
    allocate(cps%old_mss_ocpho(beg:end,-nlevsno+1:0))
    allocate(cps%old_mss_ocphi(beg:end,-nlevsno+1:0))
    ...
    allocate(cps%old_mss_dst1(beg:end,-nlevsno+1:0))
    allocate(cps%old_mss_dst2(beg:end,-nlevsno+1:0))
    allocate(cps%old_mss_dst3(beg:end,-nlevsno+1:0))
    allocate(cps%old_mss_dst4(beg:end,-nlevsno+1:0))
...
!------------------------------------------------------------------------
    ...
    allocate(ces%old_t_grnd(beg:end))
    allocate(ces%old_t_grnd_u(beg:end))
    allocate(ces%old_t_grnd_r(beg:end))
    allocate(ces%dt_grnd(beg:end))
    allocate(ces%t_soisno(beg:end,-nlevsno+1:nlevgrnd))
    allocate(ces%old_t_soisno(beg:end,-nlevsno+1:nlevgrnd))
    allocate(ces%t_soi_10cm(beg:end))
    allocate(ces%t_lake(beg:end,1:nlevlak))
    allocate(ces%old_t_lake(beg:end,1:nlevlak))
...
!------------------------------------------------------------------------
    ...
    allocate(cws%old_h2osno(beg:end))
    ...
    allocate(cws%old_h2osoi_liq(beg:end,-nlevsno+1:nlevgrnd))
    allocate(cws%old_h2osoi_ice(beg:end,-nlevsno+1:nlevgrnd))
...
!------------------------------------------------------------------------
    ...
    allocate(cef%old_eflx_urban_ac(beg:end))
    allocate(cef%old_eflx_urban_heat(beg:end))
...
!------------------------------------------------------------------------
    ...
    allocate(cwf%old_qflx_snofrz_lyr(beg:end,-nlevsno+1:0))
...
!------------------------------------------------------------------------
    ...
    allocate(lps%old_taf(beg:end))
    allocate(lps%old_qaf(beg:end))
    ...
    allocate(lps%old_sabs_roof_dir(beg:end,1:numrad))
    allocate(lps%old_sabs_roof_dif(beg:end,1:numrad))
    allocate(lps%old_sabs_sunwall_dir(beg:end,1:numrad))
    allocate(lps%old_sabs_sunwall_dif(beg:end,1:numrad))
    allocate(lps%old_sabs_shadewall_dir(beg:end,1:numrad))
    allocate(lps%old_sabs_shadewall_dif(beg:end,1:numrad))
    allocate(lps%old_sabs_improad_dir(beg:end,1:numrad))
    allocate(lps%old_sabs_improad_dif(beg:end,1:numrad))
    allocate(lps%old_sabs_perroad_dir(beg:end,1:numrad))
    allocate(lps%old_sabs_perroad_dif(beg:end,1:numrad))
