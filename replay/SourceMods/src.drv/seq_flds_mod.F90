module seq_flds_mod
  ...
  !====================================================================
   ...
   integer, parameter, private :: CXX = 2048 ! use local extra-long char
   ...
   character(len=80), dimension(nmax, 4), save :: lookup_entry
   ...
   character(CXX) :: seq_flds_l2r_states 
   character(CXX) :: seq_flds_l2r_fluxes 
   ...
   character(CXX) :: seq_flds_r2o_states 
   character(CXX) :: seq_flds_r2o_fluxes
   ...
   character(CXX) :: seq_flds_l2r_fields 
   ...
   character(CXX) :: seq_flds_r2o_fields
...
! !INPUT/OUTPUT PARAMETERS:
     ...
     character(CXX) :: l2r_states = ''
     character(CXX) :: l2r_fluxes = ''
     ...
     character(CXX) :: r2o_states = ''
     character(CXX) :: r2o_fluxes = ''
...
!-------------------------------------------------------------------------------
     ...
     call seq_flds_add(a2x_states,"Sa_old_z")
     ...
     call seq_flds_add(a2x_states,"Sa_old_u")
     ...
     call seq_flds_add(a2x_states,"Sa_old_v")
     ...
     call seq_flds_add(a2x_states,"Sa_old_tbot")
     ...
     call seq_flds_add(a2x_states,"Sa_old_ptem")
     ...
     call seq_flds_add(a2x_states,"Sa_old_shum")
     ...
     call seq_flds_add(a2x_states,"Sa_old_pbot")
     call seq_flds_add(x2l_states,"Sa_pbot")
     call seq_flds_add(x2i_states,"Sa_pbot")
     longname = 'Air density at the lowest model level'
     stdname  = 'air_density'
     units    = 'kg m-3'
     attname  = 'Sa_dens'
     call metadata_set(attname, longname, stdname, units)
     ...
     call seq_flds_add(a2x_states,"Sa_old_dens")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_rainc")
     call seq_flds_add(a2x_fluxes,"Faxa_old_rainl")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_snowc")
     call seq_flds_add(a2x_fluxes,"Faxa_old_snowl")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_lwdn")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_swndr")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_swvdr")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_swndf")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_swvdf")
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_swnet") ! diagnostic
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_bcphidry" )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_bcphodry" )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_bcphiwet" )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_ocphidry" )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_ocphodry" )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstwet1"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstwet2"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstwet3"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstwet4"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstdry1"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstdry2"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstdry3"  )
     ...
     call seq_flds_add(a2x_fluxes,"Faxa_old_dstdry4"  )
     ...
     call seq_flds_add(i2x_states,"Si_old_avsdr")
     ...
     call seq_flds_add(i2x_states,"Si_old_anidr")
     call seq_flds_add(l2x_states,"Sl_anidr")
     call seq_flds_add(xao_albedo,"So_anidr") 
     call seq_flds_add(i2x_states,"So_old_anidr")
     ...
     call seq_flds_add(i2x_states,"Si_old_avsdf")
     ...
     call seq_flds_add(i2x_states,"Si_old_anidf")
     ...
     call seq_flds_add(i2x_states,"Si_old_tref")
     call seq_flds_add(xao_states,"So_tref")
     call seq_flds_add(xao_states,"So_old_tref")
     ...
     call seq_flds_add(i2x_states,"Si_old_qref")
     call seq_flds_add(xao_states,"So_qref")
     call seq_flds_add(xao_states,"So_old_qref")
     ...
     call seq_flds_add(i2x_states,"Si_old_t")
     ...
     call seq_flds_add(i2x_states,"Si_old_snowh")
     ...
     call seq_flds_add(xao_states,"So_old_ssq")
     ...
     call seq_flds_add(xao_states,"So_old_re")
     ...
     call seq_flds_add(i2x_states,"Si_old_u10")
     call seq_flds_add(xao_states,"So_u10")
     call seq_flds_add(xao_states,"So_old_u10")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_taux")
     call seq_flds_add(i2x_fluxes,"Faii_taux")
     call seq_flds_add(i2x_fluxes,"Faii_old_taux")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_tauy")
     call seq_flds_add(i2x_fluxes,"Faii_tauy")
     call seq_flds_add(i2x_fluxes,"Faii_old_tauy")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_lat")
     call seq_flds_add(i2x_fluxes,"Faii_lat")
     call seq_flds_add(i2x_fluxes,"Faii_old_lat")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_sen")
     call seq_flds_add(i2x_fluxes,"Faii_sen")
     call seq_flds_add(i2x_fluxes,"Faii_old_sen")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_lwup")
     call seq_flds_add(i2x_fluxes,"Faii_lwup")
     call seq_flds_add(i2x_fluxes,"Faii_old_lwup")
     ...
     call seq_flds_add(xao_fluxes,"Faox_old_evap")
     call seq_flds_add(i2x_fluxes,"Faii_evap")
     call seq_flds_add(i2x_fluxes,"Faii_old_evap")
     ...
     call seq_flds_add(a2x_states,"Sa_old_pslv")
     ...
     call seq_flds_add(xao_states,"So_old_duu10n")
     ...
     call seq_flds_add(xao_states,"So_old_ustar")
     ...
     call seq_flds_add(i2x_states,"Si_old_ifrac")
     ...
     call seq_flds_add(o2x_fluxes,"Fioo_old_q")
     ...
     call seq_flds_add(o2x_states,"So_old_t")
     call seq_flds_add(x2i_states,"So_t")    

     ! Sea surface  salinity
     call seq_flds_add(o2x_states,"So_s")
     call seq_flds_add(o2x_states,"So_old_s")
     ...
     call seq_flds_add(o2x_states,"So_old_u")
     ...
     call seq_flds_add(o2x_states,"So_old_v")
     ...
     call seq_flds_add(o2x_states,"So_old_dhdx")
     ...
     call seq_flds_add(o2x_states,"So_old_dhdy")
     ...
     stdname  = 'flodding_water_flux_back_to_land'
     units    = 'kg m-2 s-1'
     attname  = 'Flrr_flood'
     call metadata_set(attname, longname, stdname, units)
     ...
     call shr_string_listIntersect(seq_flds_l2x_states,seq_flds_x2r_states,seq_flds_l2r_states)
     call shr_string_listIntersect(seq_flds_r2x_states,seq_flds_x2o_states,seq_flds_r2o_states)
     ...
     call shr_string_listIntersect(seq_flds_l2x_fluxes,seq_flds_x2r_fluxes,seq_flds_l2r_fluxes)
     call shr_string_listIntersect(seq_flds_r2x_fluxes,seq_flds_x2o_fluxes,seq_flds_r2o_fluxes)
     ...
     if (seq_comm_iamroot(ID)) then
        ...
        write(6,"(A)")'seq_flds_mod: seq_flds_l2r_states= ',trim(seq_flds_l2r_states)
        write(6,"(A)")'seq_flds_mod: seq_flds_l2r_fluxes= ',trim(seq_flds_l2r_fluxes)
        ...
        write(6,"(A)")'seq_flds_mod: seq_flds_r2o_states= ',trim(seq_flds_r2o_states)
        write(6,"(A)")'seq_flds_mod: seq_flds_r2o_fluxes= ',trim(seq_flds_r2o_fluxes)
     ...
     call catFields(seq_flds_l2r_fields, seq_flds_l2r_states, seq_flds_l2r_fluxes)
     ...
     call catFields(seq_flds_r2o_fields, seq_flds_r2o_states, seq_flds_r2o_fluxes)
   ...
   subroutine metadata_set(attname , longname, stdname , units   )
     ...
     n = n+1
     if (n > nmax) then
        write(6,*)'n= ',n,' nmax = ',nmax,' attname= ',trim(attname)
        call shr_sys_abort('nmax fields in lookup_entry table exceeded') 
     end if

     lookup_entry(n,1) = trim(attname )
     lookup_entry(n,2) = trim(longname)
     lookup_entry(n,3) = trim(stdname )
     lookup_entry(n,4) = trim(units   )
