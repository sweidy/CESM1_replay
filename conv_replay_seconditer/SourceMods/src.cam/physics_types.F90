...
!-------------------------------------------------------------------------------
  type physics_state
     ...
     real(r8), dimension(pcols,pver)             :: &
          ...
          sforcebase,  &! static energy difference
          uforcebase,  &! zonal wind difference
          vforcebase,  &! meridional wind difference
          qforcebase,  &! first moment moisture difference
          sconvforce, &! static energy convective forcing
          uconvforce, &! static energy convective forcing
          vconvforce, &! static energy convective forcing
          qconvforce, &! static energy convective forcing
