...
! !USES:
    ...
    use clm_varorb      ,only : eccen, obliqr, lambm0, mvelpp
    use restFileMod     ,only : restFile_read, restFile_filename, restFile_open, restFile_close
    use shr_file_mod    ,only : shr_file_setLogUnit, shr_file_setLogLevel, &
                                shr_file_getLogUnit, shr_file_getLogLevel
    use seq_cdata_mod   ,only : seq_cdata, seq_cdata_setptrs
...
! !LOCAL VARIABLES:
    ...
    integer :: tod,todminus                        ! CLM current time of day (sec)
    ...
    character(12), parameter :: filestart = "../rest/"
    character(12), parameter :: slash = "/"
    type(file_desc_t)  :: ncid        ! netcdf id
    character(len=50) :: filer 
    character(len=32)            :: rest_date 
...
!       call endrun( sub//":: CLM clock not in sync with Master Sync clock 2" )
    end if
...
! FSUN24               = old_FSUN24
 ...
 cptr%cps%SNOWDP               = cptr%cps%old_SNOWDP
 cptr%ces%T_GRND               = cptr%ces%old_T_GRND
 cptr%ces%T_GRND_R             = cptr%ces%old_T_GRND_R
 cptr%ces%T_GRND_U             = cptr%ces%old_T_GRND_U
 cptr%cef%EFLX_URBAN_HEAT      = cptr%cef%old_EFLX_URBAN_HEAT
 cptr%cws%WA                   = cptr%cws%old_WA
 cptr%cws%WT                   = cptr%cws%old_WT
 cptr%cws%ZWT                  = cptr%cws%old_ZWT
 cptr%cps%coszen               = cptr%cps%old_coszen
 cptr%cps%frac_sno             = cptr%cps%old_frac_sno

 cptr%cws%H2OSOI_ICE         = cptr%cws%old_H2OSOI_ICE
 cptr%cws%H2OSOI_LIQ         = cptr%cws%old_H2OSOI_LIQ
 cptr%ces%T_SOISNO           = cptr%ces%old_T_SOISNO



 cptr%ces%T_LAKE             = cptr%ces%old_T_LAKE



 cptr%cps%flx_absdv          = cptr%cps%old_flx_absdv
 cptr%cps%flx_absin          = cptr%cps%old_flx_absin
 cptr%cps%flx_absiv          = cptr%cps%old_flx_absiv
 cptr%cps%flx_absdn          = cptr%cps%old_flx_absdn



 cptr%cps%DZ                 = cptr%cps%old_DZ
 cptr%cps%ZI                 = cptr%cps%old_ZI
 cptr%cps%Z                  = cptr%cps%old_Z
 cptr%cps%mss_bcphi          = cptr%cps%old_mss_bcphi
 cptr%cps%mss_bcpho          = cptr%cps%old_mss_bcpho
 cptr%cps%mss_dst1           = cptr%cps%old_mss_dst1
 cptr%cps%mss_dst2           = cptr%cps%old_mss_dst2
 cptr%cps%mss_dst3           = cptr%cps%old_mss_dst3
 cptr%cps%mss_dst4           = cptr%cps%old_mss_dst4
 cptr%cps%mss_ocphi          = cptr%cps%old_mss_ocphi
 cptr%cps%mss_ocpho          = cptr%cps%old_mss_ocpho
 cptr%cwf%qflx_snofrz_lyr    = cptr%cwf%old_qflx_snofrz_lyr
 cptr%cps%snw_rds            = cptr%cps%old_snw_rds



 cptr%cps%albgrd             = cptr%cps%old_albgrd
 cptr%cps%albgri             = cptr%cps%old_albgri
 cptr%cps%albsnd_hst         = cptr%cps%old_albsnd_hst
 cptr%cps%albsni_hst         = cptr%cps%old_albsni_hst




 pptr%pps%FWET                 = pptr%pps%old_FWET
 pptr%pws%H2OCAN               = pptr%pws%old_H2OCAN
     pptr%WTCOL                =     pptr%old_WTCOL
     pptr%WTGCELL              =     pptr%old_WTGCELL
     pptr%WTLUNIT              =     pptr%old_WTLUNIT
 pptr%pes%T_REF2M              = pptr%pes%old_T_REF2M
 pptr%pes%T_REF2M_R            = pptr%pes%old_T_REF2M_R
 pptr%pes%T_REF2M_U            = pptr%pes%old_T_REF2M_U
 pptr%pes%T_VEG                = pptr%pes%old_T_VEG
 pptr%pps%elai                 = pptr%pps%old_elai
 pptr%pps%esai                 = pptr%pps%old_esai
 pptr%pps%fsun                 = pptr%pps%old_fsun
 pptr%pps%gdir                 = pptr%pps%old_gdir
 pptr%pps%hbot                 = pptr%pps%old_hbot
 pptr%pps%htop                 = pptr%pps%old_htop
 pptr%pps%tlai                 = pptr%pps%old_tlai
 pptr%pps%tsai                 = pptr%pps%old_tsai
 pptr%pef%EFLX_LWRAD_OUT       = pptr%pef%old_EFLX_LWRAD_OUT
 pptr%pps%FRAC_VEG_NOSNO_ALB   = pptr%pps%old_FRAC_VEG_NOSNO_ALB


 pptr%pps%albd               = pptr%pps%old_albd
 pptr%pps%albi               = pptr%pps%old_albi
 pptr%pps%fabd               = pptr%pps%old_fabd
 pptr%pps%fabi               = pptr%pps%old_fabi
 pptr%pps%ftdd               = pptr%pps%old_ftdd
 pptr%pps%ftid               = pptr%pps%old_ftid
 pptr%pps%ftii               = pptr%pps%old_ftii
 pptr%pps%omega              = pptr%pps%old_omega

lptr%lps%sabs_roof_dir      = lptr%lps%old_sabs_roof_dir
lptr%lps%sabs_roof_dif      = lptr%lps%old_sabs_roof_dif
lptr%lps%sabs_sunwall_dir   = lptr%lps%old_sabs_sunwall_dir
lptr%lps%sabs_sunwall_dif   = lptr%lps%old_sabs_sunwall_dif
lptr%lps%sabs_shadewall_dir = lptr%lps%old_sabs_shadewall_dir
lptr%lps%sabs_shadewall_dif = lptr%lps%old_sabs_shadewall_dif
lptr%lps%sabs_improad_dir   = lptr%lps%old_sabs_improad_dir
lptr%lps%sabs_improad_dif   = lptr%lps%old_sabs_improad_dif
lptr%lps%sabs_perroad_dir   = lptr%lps%old_sabs_perroad_dir
lptr%lps%sabs_perroad_dif   = lptr%lps%old_sabs_perroad_dif



 lptr%lps%qaf                  = lptr%lps%old_qaf
 lptr%lps%taf                  = lptr%lps%old_taf
...
if (mod(tod_sync,21600)==0 .and. .not. do_restart) then 
 ...
 cptr%cps%old_SNOWDP               = cptr%cps%SNOWDP
 cptr%ces%old_T_GRND               = cptr%ces%T_GRND
 cptr%ces%old_T_GRND_R             = cptr%ces%T_GRND_R
 cptr%ces%old_T_GRND_U             = cptr%ces%T_GRND_U
 cptr%cef%old_EFLX_URBAN_HEAT      = cptr%cef%EFLX_URBAN_HEAT
 cptr%cws%old_WA                   = cptr%cws%WA
 cptr%cws%old_WT                   = cptr%cws%WT
 cptr%cws%old_ZWT                  = cptr%cws%ZWT
 cptr%cps%old_coszen               = cptr%cps%coszen
 cptr%cps%old_frac_sno             = cptr%cps%frac_sno
              

 cptr%cws%old_H2OSOI_ICE         = cptr%cws%H2OSOI_ICE
 cptr%cws%old_H2OSOI_LIQ         = cptr%cws%H2OSOI_LIQ
 cptr%ces%old_T_SOISNO           = cptr%ces%T_SOISNO



 cptr%ces%old_T_LAKE             = cptr%ces%T_LAKE



 cptr%cps%old_flx_absdv          = cptr%cps%flx_absdv
 cptr%cps%old_flx_absin          = cptr%cps%flx_absin
 cptr%cps%old_flx_absiv          = cptr%cps%flx_absiv
 cptr%cps%old_flx_absdn          = cptr%cps%flx_absdn



 cptr%cps%old_DZ                 = cptr%cps%DZ
 cptr%cps%old_ZI                 = cptr%cps%ZI
 cptr%cps%old_Z                  = cptr%cps%Z
 cptr%cps%old_mss_bcphi          = cptr%cps%mss_bcphi
 cptr%cps%old_mss_bcpho          = cptr%cps%mss_bcpho
 cptr%cps%old_mss_dst1           = cptr%cps%mss_dst1
 cptr%cps%old_mss_dst2           = cptr%cps%mss_dst2
 cptr%cps%old_mss_dst3           = cptr%cps%mss_dst3
 cptr%cps%old_mss_dst4           = cptr%cps%mss_dst4
 cptr%cps%old_mss_ocphi          = cptr%cps%mss_ocphi
 cptr%cps%old_mss_ocpho          = cptr%cps%mss_ocpho
 cptr%cwf%old_qflx_snofrz_lyr    = cptr%cwf%qflx_snofrz_lyr
 cptr%cps%old_snw_rds            = cptr%cps%snw_rds



 cptr%cps%old_albgrd             = cptr%cps%albgrd
 cptr%cps%old_albgri             = cptr%cps%albgri
 cptr%cps%old_albsnd_hst         = cptr%cps%albsnd_hst
 cptr%cps%old_albsni_hst         = cptr%cps%albsni_hst




 pptr%pps%old_FWET                 = pptr%pps%FWET
 pptr%pws%old_H2OCAN               = pptr%pws%H2OCAN
     pptr%old_WTCOL                =     pptr%WTCOL
     pptr%old_WTGCELL              =     pptr%WTGCELL
     pptr%old_WTLUNIT              =     pptr%WTLUNIT
 pptr%pes%old_T_REF2M              = pptr%pes%T_REF2M
 pptr%pes%old_T_REF2M_R            = pptr%pes%T_REF2M_R
 pptr%pes%old_T_REF2M_U            = pptr%pes%T_REF2M_U
 pptr%pes%old_T_VEG                = pptr%pes%T_VEG
 pptr%pps%old_elai                 = pptr%pps%elai
 pptr%pps%old_esai                 = pptr%pps%esai
 pptr%pps%old_fsun                 = pptr%pps%fsun
 pptr%pps%old_gdir                 = pptr%pps%gdir
 pptr%pps%old_hbot                 = pptr%pps%hbot
 pptr%pps%old_htop                 = pptr%pps%htop
 pptr%pps%old_tlai                 = pptr%pps%tlai
 pptr%pps%old_tsai                 = pptr%pps%tsai
 pptr%pef%old_EFLX_LWRAD_OUT       = pptr%pef%EFLX_LWRAD_OUT
 pptr%pps%old_FRAC_VEG_NOSNO_ALB   = pptr%pps%FRAC_VEG_NOSNO_ALB
              

 pptr%pps%old_albd               = pptr%pps%albd
 pptr%pps%old_albi               = pptr%pps%albi
 pptr%pps%old_fabd               = pptr%pps%fabd
 pptr%pps%old_fabi               = pptr%pps%fabi
 pptr%pps%old_ftdd               = pptr%pps%ftdd
 pptr%pps%old_ftid               = pptr%pps%ftid
 pptr%pps%old_ftii               = pptr%pps%ftii
 pptr%pps%old_omega              = pptr%pps%omega

lptr%lps%old_sabs_roof_dir      = lptr%lps%sabs_roof_dir
lptr%lps%old_sabs_roof_dif      = lptr%lps%sabs_roof_dif
lptr%lps%old_sabs_sunwall_dir   = lptr%lps%sabs_sunwall_dir
lptr%lps%old_sabs_sunwall_dif   = lptr%lps%sabs_sunwall_dif
lptr%lps%old_sabs_shadewall_dir = lptr%lps%sabs_shadewall_dir
lptr%lps%old_sabs_shadewall_dif = lptr%lps%sabs_shadewall_dif
lptr%lps%old_sabs_improad_dir   = lptr%lps%sabs_improad_dir
lptr%lps%old_sabs_improad_dif   = lptr%lps%sabs_improad_dif
lptr%lps%old_sabs_perroad_dir   = lptr%lps%sabs_perroad_dir
lptr%lps%old_sabs_perroad_dif   = lptr%lps%sabs_perroad_dif

 lptr%lps%old_qaf                  = lptr%lps%qaf
 lptr%lps%old_taf                  = lptr%lps%taf                      
