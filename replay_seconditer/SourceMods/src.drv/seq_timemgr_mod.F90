...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/seqinst_tags/seqinst06_cesm1_1_0_n01_drvseq4_2_08/shr/seq_timemgr_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!EOP
    ...
    integer :: n    
    type(ESMF_Time) :: drvCT,clkCT, continue_time
    integer :: rc    ! Return code
...
!call seq_timemgr_EClockGetData( SyncClock%ECP(seq_timemgr_nclock_drv)%EClock,start_ymd=start_ymd)
   ...
   call ESMF_ClockAdvance( SyncClock%ECP(seq_timemgr_nclock_drv)%EClock,rc=rc,start_ymd=continue_ymd,start_tod=continue_tod )
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_atmrun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_atm)%EClock, rc=rc,is_atm=.TRUE.,start_ymd=continue_ymd,start_tod=continue_tod)
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_lndrun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_lnd)%EClock, rc=rc,start_ymd=continue_ymd,start_tod=continue_tod)
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_rofrun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_rof)%EClock, rc=rc,is_ocean=.TRUE.,start_ymd=continue_ymd,start_tod=continue_tod)
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_ocnrun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_ocn)%EClock, rc=rc,start_ymd=continue_ymd,start_tod=continue_tod)
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_icerun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_ice)%EClock, rc=rc,start_ymd=continue_ymd,start_tod=continue_tod)
   ...
   if (ESMF_AlarmIsRinging(SyncClock%EAlarm(seq_timemgr_nclock_drv,seq_timemgr_nalarm_glcrun))) then
      call ESMF_ClockAdvance(SyncClock%ECP(seq_timemgr_nclock_glc)%EClock, rc=rc,is_ocean=.TRUE.,start_ymd=continue_ymd,start_tod=continue_tod)
...
!-------------------------------------------------------------------------------
    ...
    call ESMF_ClockSet(EClock, continueTime=currTime, rc=rc )
    call seq_timemgr_ESMFCodeCheck(rc, subname//': Error from ESMF_ClockSet')
    do while( clocktime < CurrTime)
       call ESMF_ClockAdvance( EClock, rc=rc ,is_initial=.TRUE.)
