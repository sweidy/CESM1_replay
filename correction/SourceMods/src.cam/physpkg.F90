...
!-----------------------------determine filename--------------------------------------
   if (mon<10) then
       if (day<10) then
           write (filename, '("/n/holylfs04/LABS/kuang_lab/Lab/sweidman/IC/spcam_fixreplay.","0", I1,"-0",I1,"-",I1,".nc")' ) mon, day,modstep
       else 
          write (filename,'("/n/holylfs04/LABS/kuang_lab/Lab/sweidman/IC/spcam_fixreplay.","0",I1,"-",I2,"-",I1,".nc")' ) mon, day,modstep 
       endif 
    else   
       if (day<10) then
          write (filename,'("/n/holylfs04/LABS/kuang_lab/Lab/sweidman/IC/spcam_fixreplay.",I2,"-0",I1,"-",I1,".nc")' ) mon, day,modstep 
       else 
          write (filename,'("/n/holylfs04/LABS/kuang_lab/Lab/sweidman/IC/spcam_fixreplay.",I2,"-",I2,"-",I1,".nc")' ) mon, day,modstep 
       endif 
    endif  
